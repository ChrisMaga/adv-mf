...
export default function Hero() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(to right, rgba(7,23,32,0.92) 75%, rgba(7,23,32,0.55) 100%), url('/hero-bg.jpg') center/cover no-repeat",
      }}
    >
      ...
      <div className="max-w-300 mx-auto px-6 pt-28 pb-16 relative z-2">
        <div className="max-w-175">         
          ...
          {/* Stats */}
          <div
            className="flex gap-12 mt-18 pt-12 border-t border-muted/12 flex-wrap"
          ...
          >
            {[
              ...
              <div key={stat.label}>
                ...
                <div className="text-[12px] text-muted tracking-[1px] uppercase font-title">
                  {stat.label}
                </div>
              </div>
            ))}
