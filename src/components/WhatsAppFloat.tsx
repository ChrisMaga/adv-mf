...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 w-14 h-14 bg-whatsapp rounded-full flex items-center justify-center z-200 transition-all duration-300 hover:scale-110 hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(46,183,96,0.5)]"
      style={{
        boxShadow: "0 4px 24px rgba(46,183,96,0.4)",
